...
class Eval:
    ...
    def __init__(self):
        self.alma_sdg= pd.read_csv(os.path.join(os.pardir, 'datasets', 'alma_sdg.csv')).sort_values(by='handle').reset_index(drop=True)
...
class OSDG_eval(Eval):
    ...
    def __init__(self):
        super().__init__()
        self.predictions = pd.read_csv(os.path.join(os.pardir, 'datasets','other_tools', 'osdg_prediction.csv')).sort_values(by='handle').reset_index(drop=True)
...
class ElsevierMulti_eval(Eval):
    ...
    def __init__(self):
        super().__init__()
        self.predictions = pd.read_csv(os.path.join(os.pardir, 'datasets','other_tools', 'elsevier-sdg-multi.csv')).sort_values(by='handle').reset_index(drop=True)
...
class Aurora_eval(Eval):
    ...
    def __init__(self):
        ...
        self.predictions = pd.read_csv(os.path.join(os.pardir, 'datasets','other_tools', 'aurora-sdg-multi.csv')).sort_values(by='handle').reset_index(drop=True)
...
class GPT_eval(Eval):
    ...
    def __init__(self):
        super().__init__()
        self.model_name = 'gpt'
        self.predictions = pd.read_excel(os.path.join(os.pardir, 'datasets','other_tools', 'gpt_answers_20082024_t00.xlsx'), sheet_name='ProcessedOutput').sort_values(by='handle').reset_index(drop=True)
...
class Gemini_eval(Eval):
    ...
    def __init__(self):
        ...
        self.predictions = pd.read_excel(os.path.join(os.pardir, 'datasets','other_tools', 'gemini_results_temp00_270824.xlsx'), sheet_name='ProcessedOutput').sort_values(by='handle').reset_index(drop=True)
...
class LLama_eval(Eval):
    ...
    def __init__(self):
        ...
        self.predictions = pd.read_excel(os.path.join(os.pardir, 'datasets','other_tools', 'llama_01_05_25.xlsx'), sheet_name='ProcessedOutput').sort_values(by='handle').reset_index(drop=True)
        # self.alma_sdg = self.alma_sdg.sort_values(by='handle').reset_index(drop=True)
